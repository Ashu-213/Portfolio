  ...
  return (
    <section className="pt-4 pb-10 px-4 max-w-7xl mx-auto flex flex-col md:flex-row gap-8 items-start justify-center">
      ...
      <div className="w-full md:w-1/3 bg-white border-2 border-b-4 border-r-4 border-black rounded-3xl p-6 shadow-neo flex flex-col items-center text-center relative overflow-hidden">
        ...
        <h1 className="text-4xl font-shrikhand mb-1">Ashutosh</h1>
        ...
        <div className="flex gap-4 mt-6 text-2xl flex-wrap justify-center">
          <a href="mailto:ashuptdr4@gmail.com" className="hover:scale-110 transition-transform text-red-500"><FaEnvelope /></a>
      ...
      <div className="w-full md:w-2/3 flex flex-col gap-6" id="about">
        ...
        <div className="bg-custom-yellow p-6 md:p-10 rounded-3xl border-2 border-b-4 border-r-4 border-black shadow-neo">
          ...
          <p className="text-lg font-medium leading-relaxed mb-4">
            I am a <span className="font-bold bg-white px-1 border border-black">3rd-year student at VIT Bhopal</span>, pursuing a Bachelor + Master of Technology in Computer Science and Engineering with specialization in Computational and Data Science. I define myself as a <span className="font-bold bg-white px-1 border border-black">STEM STUDENT</span> aspiring to build scalable software.
          </p>
          <p className="text-lg font-medium leading-relaxed mb-4">
