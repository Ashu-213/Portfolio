    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
      <div className="bg-white w-full max-w-md border-4 border-black rounded-3xl p-6 shadow-neo relative animate-bounce-in">
        ...
        <div className="flex flex-col gap-4 font-bold">
          <a href="mailto:ashuptdr4@gmail.com" className="flex items-center gap-3 p-3 bg-custom-yellow border-2 border-black rounded-xl hover:translate-x-1 hover:shadow-neo-sm transition-all">
            <FaEnvelope className="text-xl" /> ashuptdr4@gmail.com
          </a>
          <a href="https://github.com/Ashu-213" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 bg-gray-200 border-2 border-black rounded-xl hover:translate-x-1 hover:shadow-neo-sm transition-all">
            <FaGithub className="text-xl" /> GitHub
          </a>
          <a href="https://www.linkedin.com/in/ashutosh-patidar-04073b348/" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 bg-blue-200 border-2 border-black rounded-xl hover:translate-x-1 hover:shadow-neo-sm transition-all">
